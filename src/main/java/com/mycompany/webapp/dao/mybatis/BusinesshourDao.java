...
public interface BusinesshourDao {
	...
	public int insert(Businesshour businesshour);  //맨처음 입력?! 사실 입력도 필요없을 거 같음
	public int update(@Param("businesshour") Businesshour businesshour, @Param("newbusinesshour") Businesshour newbusinesshour);  
